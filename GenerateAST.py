#!/usr/bin/env python3
"""
Generate AST classes for the Lox language.
This is a code generation tool, not part of the interpreter itself.
"""
...
def define_ast(output_dir, base_name, types):
    """
    Generate AST class hierarchy.

    Args:
        output_dir: Directory to write the file to
        base_name: Name of the base class (e.g., "Expr")
        types: List of subclass definitions
    """
    path = f"{output_dir}/{base_name.lower()}.py"

    with open(path, 'w') as writer:
        writer.write('"""\n')
        writer.write(f'{base_name} classes for the Lox AST.\n')
        writer.write('Auto-generated by generate_ast.py\n')
        writer.write('"""\n\n')
        writer.write('from token_type import Token\n')
...
def define_type(writer, base_name, class_name, field_list):
    """
    Generate a single AST node class.

    Args:
        writer: File writer
        base_name: Name of the base class
        class_name: Name of this subclass
        field_list: Comma-separated list of fields with types
    """
